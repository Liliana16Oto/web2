...
<!-- VALIDACIO PARA QUE EN LOS CAMPOS DE APELLIDOS NO INGRESE NUMEROS -->
    <script type="text/javascript">
       ...
       <!-- IMPORTACION DE MENSAJES DE ALERTE -->
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url(); ?>/instructores/nuevo">NUEVO INSTRUCTOR</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?php echo site_url(); ?>/instructores/index">LISTADO INSTRUCTORES</a></li>
                ...
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    ...
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">
                      <?php echo $this->session->userdata("conectado")->email_usu; ?></p>
     ...
     <a class="navbar-brand" href="<?php echo site_url(); ?>">CURSOS UTC</a>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
           <ul class="nav navbar-nav">
             <li class="active"><a href="<?php echo site_url(); ?>/instructores/index">MATERIAS <span class="sr-only">(current)</span></a></li>
             ...
             <li class="dropdown">
               ...
               <ul class="dropdown-menu">
                 ...
                 <li><a href="<?php echo site_url(); ?>/instructores/index">LISTADO DE INSTRUCTORES</a></li>
             ...
             <li class="dropdown">
               ...
               <ul class="dropdown-menu">
                 ...
                 <li><a href="<?php echo site_url(); ?>/usuarios/index">LISTADO DE USUARIOS</a></li>
               </ul>
             </li>
